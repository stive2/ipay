...
use App\Http\Controllers\Agent\Auth\LoginController as AuthLoginController;
...
Route::post('/login', [AuthLoginController::class, 'sanctumLogin']);
Route::middleware(['agent.api'])->post('/storeCoordinate', [CoordinateController::class, 'store']);
Route::middleware(['agent.api'])->get('/coordinates', [CoordinateController::class, 'index']);
