...
{
    if (preg_match('/^65|66|67|68|69|22|23|24|70+[0-9]{7}$/', $string)) {
        return true;
    }
    return false;
}
...
function amountOfTransaction($transaction)
{
    return $transaction->request_amount;
}
...
function check_if_login_as_member()
{
