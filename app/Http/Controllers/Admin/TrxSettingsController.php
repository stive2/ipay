...
class TrxSettingsController extends Controller
{
    ...
    public function updateMinCommission(Request $request)
    {

        $validator = Validator::make($request->all(), [
            'min_commission_payable'           => 'required',
            'min_collect_amount'           => 'required',
        ]);
        ...
        try {
            $basic_settings->update([
                'min_commission_payable'       => $validated['min_commission_payable'],
                'min_collect_amount'       => $validated['min_collect_amount'],
            ]);
        } catch (Exception $e) {
