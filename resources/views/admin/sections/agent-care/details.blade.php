        ...
        <div class="row">
            ...
            <div class="col-xxxl-4 col-xxl-4 col-xl-4 col-lg-6 col-md-6 col-sm-12 mb-15">
                <div class="dashbord-item">
                    <div class="dashboard-content">
                        <div class="left">
                            <h6 class="title">{{ __("Total Money In") }}</h6>
                            <div class="user-info">
                                <h2 class="user-count">{{ get_amount($data['money_in_amount'], get_default_currency_code()) }}</h2>
                            </div>
                        </div>
                        <div class="right">
                            <div class="dashboard-icon">
            ...
            <div class="col-xxxl-4 col-xxl-4 col-xl-4 col-lg-6 col-md-6 col-sm-12 mb-15">
                <div class="dashbord-item">
                    <div class="dashboard-content">
                        <div class="left">
                            <h6 class="title">{{ __("Agent Profits") }} Unpaid</h6>
                            <div class="user-info">
                                <h2 class="user-count {{ $data['minCommission'] ?? '' }}">{{ get_amount($data['agent_profits'], get_default_currency_code()) }}</h2>
                            </div>
                        </div>
                        <div class="right">
                            @if ($data['payable'] == 1)
                                <div class="card-body">
                                    @include('admin.components.button.custom',[
                                                ...
                                                'text'          => "Set as paid",
                                                'permission'    => "admin.agents.details.paidprofit",
                                            ])
                                </div>
                            @else
                                <div class="card-body">
                                    @include('admin.components.button.custom',[
                                                'type'          => "button",
                                                'class'         => "btn--danger reset-btn w-100",
                                                'text'          => "Reset profit",
                                                'permission'    => "admin.agents.details.paidprofit",
                                            ])
                                </div>
...
@push('script')
    <script>
        ...
        $(".approve-btn").click(function(){
            var actionRoute = "{{ setRoute('admin.agents.details.paidprofit',$user->username) }}";
            var target      = "1";
            var message     = `Are you sure to set as paid {{ "@" . $user->username }} profits?`;
            openDeleteModal(actionRoute,target,message,"Set as paid","POST");
        });
        $(".reset-btn").click(function(){
            var actionRoute = "{{ setRoute('admin.agents.details.paidprofit',$user->username) }}";
            var target      = "2";
            var message     = `Are you sure to reset {{ "@" . $user->username }} profits?`;
            openDeleteModal(actionRoute,target,message,"Reset","POST");
        });
    </script>
@endpush
