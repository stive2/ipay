                ...
                <div class="col-xxxl-4 col-xxl-3 col-xl-3 col-lg-6 col-md-6 col-sm-12 mb-15">
                    <div class="dashbord-item">
                        <div class="dashboard-content">
                            ...
                            <a href="{{ setRoute('admin.money.in.index') }}">
                                <div class="right">
                                    <div class="chart" id="chart11" data-percent="{{ $data['money_in_percent'] }}"><span>{{ round($data['money_in_percent'],2) }}%</span></div>
                                </div>
                            </a>
                        </div>
                    </div>
                        ...
                        <div class="dashboard-content">
                            <a href="{{ setRoute('admin.agents.index') }}">
                                <div class="left">
                                    ...
                                    <div class="user-badge">
                                        <span class="badge badge--info">{{ __("active") }} {{  $data['active_agents'] }}</span>
                                        <span class="badge badge--warning">{{ __("Unverified") }} {{ $data['unverified_agents'] }}</span>
                                    </div>
                                </div>
                            </a>
                            <a href="{{ setRoute('admin.agents.index') }}">
                                <div class="right">
                                    <div class="chart" id="chart14" data-percent="{{ $data['agent_perchant'] }}"><span>{{ round($data['agent_perchant'],2) }}%</span></div>
                                </div>
                            </a>
                        </div>
                    </div>
    ...
    <div class="chart-area mt-15">
        <div class="row mb-15-none">
          ...
          <div class="col-xxl-6 col-xl-6 col-lg-6 mb-15">
              <div class="chart-wrapper">
                  <div class="chart-area-header">
                      <h5 class="title">{{ __("Agent Analytics") }}</h5>
                  </div>
                  <div class="chart-container">
                      <div id="merchants" data-chart_merchant="{{ json_encode($data['chart_agent']) }}" class="balance-chart"></div>
                  </div>
                  <div class="chart-area-footer">
                      <div class="chart-btn">
                          <a href="{{ setRoute('admin.agents.index') }}" class="btn--base w-100">{{__("View Agents")}}</a>
                      </div>
                  </div>
              </div>
          </div>
          <div class="col-xxl-12 col-xl-12 col-lg-12 mb-15">
              <div class="chart-wrapper">
                  <div class="chart-area-header">
                      <h5 class="title">
                         {{__("Monthly Money In Chart")}}
                      </h5>
                      <a href="{{ setRoute('admin.money.in.index') }}" class="btn--base "> {{__("View")}}</a>
                  </div>
                  <div class="chart-container">
