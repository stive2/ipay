                        ...
                        <tr>
                            ...
                            <td>
                                @if(@$item->transactions->user_id != null)
                                     0
                                @elseif(@$item->transactions->agent_id != null)
                                     {{ number_format(@$item->transactions->details->charges->agent_total_commission,2) }}
                                @elseif(@$item->transactions->merchant_id != null)
                                     0
                                @endif
                            ...
                            <td>
                                @if(@$item->transactions->user_id != null)
                                     0
                                @elseif(@$item->transactions->agent_id != null)
                                    {{ number_format((@$item->total_charge - @$item->transactions->details->charges->agent_total_commission),2) }}
                                @elseif(@$item->transactions->merchant_id != null)
                                     0
                                @endif
