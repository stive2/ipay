                        ...
                        <form class="card-form" action="{{ setRoute('user.send.money.confirmed') }}" method="POST">
                            ...
                            <div class="row">
                                ...
                                <div class="col-xxl-6 col-xl-12 col-lg-6 form-group paste-wrapper">
                                    <label>ID ({{ __("User") }})<span class="text--base">*</span></label>
                                    <div class="input-group">
                                        <div class="input-group-prepend">
                                            <span class="input-group-text copytext"><span>ID</span></span>
                                        </div>
                                        <input name="email" class="form--control checkUser" id="username" placeholder="{{ __("enter user ID") }}" value="{{ old('email') }}" />
                                    </div>
