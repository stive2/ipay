        ...
        <div class="dashboard-item-area">
            <div class="row mb-20-none">
                ...
                <div class="col-xxl-3 col-xl-4 col-lg-6 col-md-6 col-sm-12 mb-20">
                    <div class="dashbord-item">
                        <div class="dashboard-content">
                            ...
                            <h3 class="title">{{ getAmount($data['lastAddSubBalance'],2) }} <span class="text--base">{{ @$baseCurrency->code }}</span></h3>
                        </div>
                        <div class="dashboard-icon">
                ...
                <div class="col-xxl-3 col-xl-4 col-lg-6 col-md-6 col-sm-12 mb-20">
                    <div class="dashbord-item">
                        <div class="dashboard-content">
                            <span class="sub-title">{{__("Total Add Sub Balance")}}</span>
                            <h3 class="title">{{ getAmount($data['totalAddSubBalance'],2) }} <span class="text--base">{{ @$baseCurrency->code }}</span></h3>
                        </div>
                        <div class="dashboard-icon">
                ...
                <div class="col-xxl-3 col-xl-4 col-lg-6 col-md-6 col-sm-12 mb-20">
                    <a href="{{ setRoute('agent.profits.index') }}" class="d-block">
                        <div class="dashbord-item">
                            <div class="dashboard-content">
                                <span class="sub-title">{{ __("Agent Profits") }} Unpaid</span>
                                <h3 class="title {{ $data['minCommission'] ?? '' }}">{{ getAmount($data['agent_profits'],2) }} <span class="text--base">{{ @$baseCurrency->code }}</span></h3>
                            </div>
                            <div class="dashboard-icon">
        ...
        <div class="row mb-20-none">
            <div class="col-xxl-7 col-xl-7 col-lg-7 mb-20">
                <div class="chart-wrapper">
                    <div class="dashboard-header-wrapper">
                        <h4 class="title">{{ __("Money In Chart") }}</h4>
                    </div>
            ...
            <div class="col-xxl-5 col-xl-5 col-lg-5 mb-20">
                <div class="chart-wrapper">
                    <div class="dashboard-header-wrapper">
                        <h4 class="title">{{ __("Add/Substract Balance") }}</h4>
                    </div>
                    <div class="chart-container">
